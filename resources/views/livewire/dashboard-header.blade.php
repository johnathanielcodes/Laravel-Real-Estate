<header id="page-header" class="z-1 flex flex-none items-center">
    <div class="container mx-auto px-4 lg:px-8 xl:max-w-full">
        <div class="flex justify-between border-b-2 border-slate-200/50 py-6">
            ...
            <div class="flex items-center">
                ...
                <a href="javascript:void(0)"
                    ...
                    <svg class="hi-mini hi-square-3-stack-3d inline-block size-5 rotate-90 text-indigo-500"
            ...
            <div class="flex items-center gap-1 lg:gap-5">
                ...
                <nav class="flex items-center gap-2">
                    <a href="javascript:void(0)"
                        ...
                        <svg class="hi-mini hi-flag inline-block size-5 text-slate-300 group-hover:text-indigo-500"
                        ...
                        <span
                            class="inline-flex size-6 items-center justify-center rounded-full border border-indigo-200 bg-indigo-50 text-indigo-900">3</span>
                    </a>
                </nav>
                ...
                <div class="relative inline-block">
                    ...
                    <button type="button"
                        ...
                        <svg fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"
                            class="hi-solid hi-chevron-down inline-block size-5 text-slate-400">
                    ...
                    <div x-cloak x-show="userDropdownOpen" x-transition:enter="transition ease-out duration-150"
                        ...
                        class="absolute end-0 mt-2 w-48 rounded-sm shadow-xl shadow-slate-200 ltr:origin-top-right rtl:origin-top-left">
                        <div class="divide-y divide-slate-100 rounded-sm bg-white ring-1 ring-slate-900/5">
                            <div class="space-y-1 p-2">
                                <a role="menuitem" href="javascript:void(0)"
                                    class="group flex items-center gap-2 rounded-sm px-3 py-2 text-sm font-medium text-slate-900 hover:bg-slate-100 hover:text-slate-700"><svg
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                        aria-hidden="true"
                                        class="hi-mini hi-beaker inline-block size-5 text-slate-300 group-hover:text-indigo-500">
                                        <path fill-rule="evenodd"
                                ...
                                <a role="menuitem" href="javascript:void(0)"
                                    class="group flex items-center gap-2 rounded-sm px-3 py-2 text-sm font-medium text-slate-900 hover:bg-slate-100 hover:text-slate-700">
                                    <svg fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"
                                        class="hi-solid hi-inbox inline-block size-5 text-slate-300 group-hover:text-indigo-500">
                                        <path fill-rule="evenodd"
                            ...
                            <div class="space-y-1 p-2">
                                <a role="menuitem" href="{{ route('profile') }}"
                                    class="group flex items-center gap-2 rounded-sm px-3 py-2 text-sm font-medium text-slate-900 hover:bg-slate-100 hover:text-slate-700">
                                    <svg fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"
                                        class="hi-solid hi-user-circle inline-block size-5 text-slate-300 group-hover:text-indigo-500">
                                        <path fill-rule="evenodd"
                            ...
                            <div class="space-y-1 p-2">
                                <form onsubmit="return false;">
                                    <button type="submit" role="menuitem"
                                        class="group flex w-full items-center gap-2 rounded-sm px-3 py-2 text-sm font-medium text-slate-900 hover:bg-slate-100 hover:text-slate-700">
                                        <svg fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"
                                            class="hi-solid hi-lock-closed inline-block size-5 text-slate-300 group-hover:text-indigo-500">
                                            <path fill-rule="evenodd"
        ...
        <!-- Mobile Navigation -->
        <nav x-cloak x-show="mobileNavOpen" class="flex flex-col py-4 lg:hidden">
            <a href="javascript:void(0)"
            ...
            <div class="space-y-1.5">
                <a href="javascript:void(0)"
                    ...
                    <svg class="hi-mini hi-cursor-arrow-rays inline-block size-5 flex-none text-slate-300 group-hover:text-indigo-500"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                        aria-hidden="true">
                        <path fill-rule="evenodd"
                    ...
                    <span
                        class="inline-flex items-center justify-center rounded-full border border-indigo-200 bg-indigo-50 px-1 text-xs text-indigo-900">250</span>
                </a>
                <a href="javascript:void(0)"
                    class="group flex items-center justify-between gap-2 rounded-md border border-transparent px-2.5 py-2 text-sm font-semibold text-slate-900 hover:bg-indigo-100 hover:text-indigo-600 active:border-indigo-200">
                    <svg class="hi-mini hi-chart-bar inline-block size-5 flex-none text-slate-300 group-hover:text-indigo-500"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                        aria-hidden="true">
                        <path
            ...
            <div class="space-y-1.5">
                <a href="javascript:void(0)"
                    class="group flex items-center justify-between gap-2 rounded-md border border-transparent px-2.5 py-2 text-sm font-semibold text-slate-900 hover:bg-indigo-100 hover:text-indigo-600 active:border-indigo-200">
                    <svg class="hi-mini hi-user-group inline-block size-5 flex-none text-slate-300 group-hover:text-indigo-500"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                        aria-hidden="true">
                        <path
                    ...
                    <span
                        class="inline-flex items-center justify-center rounded-full border border-indigo-200 bg-indigo-50 px-1 text-xs text-indigo-900">563</span>
                </a>
                <a href="javascript:void(0)"
                    class="group flex items-center justify-between gap-2 rounded-md border border-transparent px-2.5 py-2 text-sm font-semibold text-slate-900 hover:bg-indigo-100 hover:text-indigo-600 active:border-indigo-200">
                    <svg class="hi-mini hi-briefcase inline-block size-5 flex-none text-slate-300 group-hover:text-indigo-500"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                        aria-hidden="true">
                        <path fill-rule="evenodd"
                    ...
                    <span
                        class="inline-flex items-center justify-center rounded-full border border-indigo-200 bg-indigo-50 px-1 text-xs text-indigo-900">1.2k</span>
                </a>
                <a href="javascript:void(0)"
                    class="group flex items-center justify-between gap-2 rounded-md border border-transparent px-2.5 py-2 text-sm font-semibold text-slate-900 hover:bg-indigo-100 hover:text-indigo-600 active:border-indigo-200">
                    <svg class="hi-mini hi-document-text inline-block size-5 flex-none text-slate-300 group-hover:text-indigo-500"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                        aria-hidden="true">
                        <path fill-rule="evenodd"
                    ...
                    <span
                        class="inline-flex items-center justify-center rounded-full border border-indigo-200 bg-indigo-50 px-1 text-xs text-indigo-900">7.5k</span>
                </a>
            </div>
        </nav>
