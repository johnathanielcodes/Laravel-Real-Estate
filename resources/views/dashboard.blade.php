<x-app-layout>
    <div class="py-12">
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-12 md:gap-6">
            ...
            <div class="overflow-hidden rounded-xl border border-slate-200 bg-white sm:col-span-12 lg:col-span-6">
                <dl class="px-6 pt-6">
                ...
                <div class="-m-2">
                    <svg class="w-auto text-indigo-100" fill="currentColor" viewBox="0 0 1000 500"
            ...
            <div class="overflow-hidden rounded-xl border border-slate-200 bg-white sm:col-span-12">
                <div class="px-6 pt-6">
                        ...
                        <table class="min-w-full align-middle text-sm">
                            ...
                            <thead>
                                <tr class="border-b-2 border-slate-100">
                                    ...
                                    <th
                                        class="hidden px-3 py-2 text-start text-sm font-semibold tracking-wider text-slate-700 uppercase md:table-cell">
                                        Email
                                    </th>
                                    <th
                                        class="hidden px-3 py-2 text-start text-sm font-semibold tracking-wider text-slate-700 uppercase md:table-cell">
                                    ...
                                    <th
                                        class="px-3 py-2 text-end text-sm font-semibold tracking-wider text-slate-700 uppercase">
                                        Total
                                    </th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                <tr>
                                    <td class="p-3 text-start">
                                        <a class="font-medium text-indigo-500 hover:text-indigo-700"
                                            href="javascript:void(0)">order_0006578</a>
                                    </td>
                                    ...
                                    <td class="hidden p-3 text-start md:table-cell">
                                        <div
                                            class="inline-block rounded-full border border-orange-200 bg-orange-50 px-2 py-1 text-xs leading-4 font-semibold text-orange-700">
                                            Pending
                                        </div>
                                    </td>
                                ...
                                <tr class="bg-slate-50">
                                    <td class="p-3 text-start">
                                        <a class="font-medium text-indigo-500 hover:text-indigo-700"
                                            href="javascript:void(0)">order_0006577</a>
                                    </td>
                                    <td class="hidden p-3 text-slate-600 md:table-cell">
                                        j.keily@example.com
                                    </td>
                                ...
                                <tr>
                                    <td class="p-3 text-start">
                                        <a class="font-medium text-indigo-500 hover:text-indigo-700"
                                            href="javascript:void(0)">order_0006576</a>
                                    </td>
                                    <td class="hidden p-3 text-slate-600 md:table-cell">
                                        n.hart@example.com
                                    </td>
                                    <td class="hidden p-3 text-start md:table-cell">
                                        <div
                                            class="inline-block rounded-full border border-emerald-200 bg-emerald-50 px-2 py-1 text-xs leading-4 font-semibold text-emerald-700">
                                            Completed
                                        </div>
                                    </td>
                                ...
                                <tr class="bg-slate-50">
                                    <td class="p-3 text-start">
                                        <a class="font-medium text-indigo-500 hover:text-indigo-700"
                                            href="javascript:void(0)">order_0006575</a>
                                    </td>
                                    <td class="hidden p-3 text-slate-600 md:table-cell">
                                        j.doe@example.com
                                    </td>
                                ...
                                <tr>
                                    <td class="p-3 text-start">
                                        <a class="font-medium text-indigo-500 hover:text-indigo-700"
                                            href="javascript:void(0)">order_0006574</a>
                                    </td>
                                    <td class="hidden p-3 text-slate-600 md:table-cell">
                                        o.smith@example.com
                                    </td>
                                ...
                                <tr class="bg-slate-50">
                                    <td class="p-3 text-start">
                                        <a class="font-medium text-indigo-500 hover:text-indigo-700"
                                            href="javascript:void(0)">order_0006573</a>
                                    </td>
                                    <td class="hidden p-3 text-slate-600 md:table-cell">
                                        n.hart@example.com
                                    </td>
